...
1. Copy the file **Microsoft.ConfigurationManagement.Messaging.dll** to \<***Inetpub Dir***\>\wwwroot\MessagingDll on each Management Point. The \wwwroot\ should already exist on each MP, but the MessagingDll directory will need created.
